...
make dev-test                                  # branch gate: ≤6 min, ≥50% of 36 decision paths; SEED=N replays, BUDGET=N cap
...
1. Create `tests/custom/NNN_my-test.sh` (3-digit slot, leave gaps: 010, 020, …); **next slot: 490_**
