...
| `configs/canary.config` | Config fragment for `CANARY=1` mode: sets `CONFIG_BOOT_CANARY=y` and `CONFIG_DEBUG_42=y`; appended by `lib/build.sh` step 1b.2 when `CANARY=1` |
