...
- **Tests:** 49 total (1 smoke + 48 custom; see test-inventory.md); next slot: 480_
...
├── tests/
│   ├── 001_smoke.sh
│   ├── custom/     001_print-dmesg + 010_ … 470_ (48 scripts)
...
│   └── programs/   C helper programs injected into the initramfs (perf-event, arena-test, syscall-tests)
