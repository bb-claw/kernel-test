...
| `randkconfigconfig-<OPT>` | yes | tinyconfig | `configs/randkconfigconfig.config` | Generated by `lib/build-kconfig.sh`; one per config entry; not in default CONFIGS list |
