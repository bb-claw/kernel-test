...
Targets:
  bootstrap        Install all build and test dependencies (distro-aware, needs sudo); installs musl-tools; builds C test binaries (tests/ns/ ns-uts…ns-time, tests/programs/ perf-event arena-test syscall-tests serial-capture); downloads Toybox; activates git hooks
